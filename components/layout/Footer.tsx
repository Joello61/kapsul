      ...
      <div className="bg-cream py-16">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 w-full relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full overflow-hidden opacity-[0.02] pointer-events-none select-none">
            <span className="text-[8vw] font-sans font-bold leading-none text-charcoal text-center block whitespace-nowrap">
              KAPSUL
            </span>
          </div>
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-12">
            ...
            <div className="lg:col-span-4 space-y-6">
              <Link href="/" className="inline-block group">
                <span className="font-sans font-semibold text-3xl text-charcoal flex items-center gap-2">
                  KAPSUL
              ...
              <p className="text-gray-700 text-sm max-w-xs leading-relaxed">
                Le sanctuaire urbain de récupération. Tech et Touch pour votre
              ...
              <div className="flex items-center gap-6 pt-2">
                ...
                <div>
                  <div className="font-sans text-2xl font-semibold text-sage-600">
                    4.9/5
                  </div>
              ...
              <div className="pt-4">
                ...
                {status === 'success' && (
                  <p className="text-sage-700 text-xs mt-2 font-medium">
                    ✓ Merci !
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2.5 text-sm text-gray-600">
                  <li className="leading-relaxed">
                    <strong className="text-charcoal block text-xs mb-1">
                      Lun - Ven
                    </strong>
                    9h - 20h
                  </li>
