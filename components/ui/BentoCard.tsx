    ...
    >
      ...
      {image && imagePosition === 'background' && (
        <>
          ...
          <div className="relative z-10 p-8 sm:p-10 flex flex-col justify-end h-full mt-auto">
            ...
            <h3 className="font-sans text-3xl md:text-4xl font-semibold text-white mb-4 leading-tight">
              {title}
            </h3>
      ...
      {image && imagePosition === 'top' && (
        <>
          ...
          <div className="p-8 flex flex-col grow">
            <h3 className="font-sans text-2xl font-semibold text-charcoal mb-3 group-hover:text-sage-700 transition-colors duration-300">
              {title}
            </h3>
      ...
      {!image && (
        <div className="relative p-8 h-full flex flex-col">
          ...
          <h3 className="font-sans text-2xl md:text-3xl font-semibold text-charcoal mb-4 group-hover:text-sage-700 transition-colors duration-300">
            {title}
          </h3>
          ...
          <div className="mt-6 pt-6 border-t border-sage-100">{children}</div>
        </div>
      )}
    </div>
  );
