...
import { ArrowRight, PlayCircle, Star, Sparkles, Clock, Shield, Zap, CheckCircle2 } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Background Elements - Organic Blobs with parallax */}
      <motion.div 
        style={{ y }}
        className="absolute top-0 right-0 w-[700px] h-[700px] bg-sage-200/30 blur-[140px] rounded-full translate-x-1/3 -translate-y-1/3 pointer-events-none" 
      />
      <motion.div 
        style={{ y: useTransform(scrollYProgress, [0, 1], [0, -80]) }}
        className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-terra-400/20 blur-[140px] rounded-full -translate-x-1/3 translate-y-1/3 pointer-events-none" 
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="space-y-6">
              <motion.h1 
                variants={fadeInUp} 
                className="font-serif text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tight leading-[1.1] text-charcoal"
              >
                Réparer le corps.
                <br />
              ...
              >
                Dans un monde qui ne s&apos;arrête jamais, offrez-vous une pause qui compte. 
                <strong className="font-semibold text-charcoal"> 20 minutes</strong> suffisent pour transformer votre journée.
              </motion.p>
              ...
              >
                {microBenefits.map((benefit, idx) => (
                  ...
                  >
                    <benefit.icon className={`w-4 h-4 ${benefit.color}`} strokeWidth={2} />
                    <span className="text-sm font-medium text-charcoal">{benefit.text}</span>
                  </div>
                ))}
              </motion.div>
            </div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4">
              <button className="group relative w-full sm:w-auto bg-sage-600 text-white px-8 py-4 rounded-full font-semibold text-base shadow-md hover:shadow-lg hover:bg-sage-700 transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-2.5 overflow-hidden">
                <span className="relative z-10">Réserver ma première pause</span>
              ...
              <button className="group w-full sm:w-auto px-8 py-4 rounded-full font-semibold text-base text-charcoal glass border border-sage-100 hover:border-sage-200 transition-all duration-300 flex items-center justify-center gap-2.5 active:scale-[0.98]">
                <PlayCircle className="w-5 h-5 text-sage-600 transition-colors" strokeWidth={2} />
            ...
            <motion.div variants={fadeInUp} className="pt-6 flex flex-wrap gap-8 items-center border-t border-sage-200/30">
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="font-serif text-4xl font-semibold text-charcoal leading-none mb-1">
                ...
                <div className="text-center">
                  <div className="font-serif text-4xl font-semibold text-sage-600 leading-none mb-1">6</div>
                  <div className="text-xs text-gray-500 uppercase tracking-wider font-medium">
                    Protocoles
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="font-serif text-4xl font-semibold text-terra-600 leading-none mb-1">
                    10€
                  </div>
                  <div className="text-xs text-gray-500 uppercase tracking-wider font-medium">
                    Dès 9h
          ...
          >
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-charcoal/5 bg-sage-100 aspect-4/5 group">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-right">
                    <div className="font-serif font-semibold text-2xl text-sage-700">-78%</div>
              ...
              >
                <div className="glass px-4 py-2 rounded-full backdrop-blur-md border border-white/30">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-charcoal">Tech+Touch</span>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="glass px-4 py-2 rounded-full backdrop-blur-md border border-white/30">
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-sage-600" strokeWidth={2} />
                    <span className="text-sm font-semibold text-charcoal">Dispo aujourd&apos;hui</span>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-sage-300/20 rounded-full blur-[120px] pointer-events-none" />
          </motion.div>
