...
import { Zap, Heart, TrendingDown, Code, Brain, Coffee, Users, Target, Lightbulb, Award } from 'lucide-react';
...
const milestones = [
  ...
  { year: '2024', title: 'Prototype', desc: 'Premier K-Pod testé par 50 étudiants' },
  { year: '2025', title: 'Ouverture', desc: 'St-Cyprien accueille notre sanctuaire' },
  { year: '2026', title: 'Expansion', desc: 'Toulouse, Paris, Lyon... (à venir)' }
];

const impact = [
  { icon: Users, value: '500+', label: 'Utilisateurs actifs', sublabel: 'en 6 mois' },
  { icon: Target, value: '3,200', label: 'Sessions réalisées', sublabel: 'depuis janvier' },
  { icon: Award, value: '4.8/5', label: 'Satisfaction globale', sublabel: 'sur 200+ avis' }
];
  ...
  return (
    <div className="min-h-screen bg-stone">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-cream">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-sage-200/30 rounded-full blur-[140px] translate-x-1/3 -translate-y-1/3 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-terra-400/20 rounded-full blur-[140px] -translate-x-1/3 translate-y-1/3 pointer-events-none" />
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-5xl relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-sage-200/30 mb-4">
              ...
              <span className="text-sm font-semibold text-charcoal">Notre histoire</span>
            </div>
            
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold text-charcoal leading-tight">
              L&apos;Origine du Reset.
            </h1>
            
            <p className="text-xl text-sage-600 font-medium max-w-2xl mx-auto">
              Créé par des étudiants épuisés, pour tous ceux qui n&apos;ont jamais le temps de souffler.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-5xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sage-50 border border-sage-200/50">
              ...
              <span className="text-sm font-semibold text-sage-700">Genèse</span>
            </div>

            <div className="prose prose-lg max-w-none space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                L&apos;idée de KAPSUL est née en <strong className="text-charcoal">novembre 2023</strong>, dans une salle de TP informatique. 
                Après 8 heures de code sans pause, nous avions mal au dos, les yeux explosés, et le cerveau en brouillard total.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Nous cherchions un endroit pour <span className="text-sage-600 font-semibold">décompresser rapidement</span>, mais rien n&apos;existait : 
                les Spas demandent 2h et 90€, les salles de sport nécessitent trop d&apos;énergie, et le café du coin... c&apos;est juste du café.
              </p>
              
              <p className="text-lg text-gray-700 leading-relaxed">
                Alors nous avons décidé de <strong className="text-charcoal">créer ce lieu nous-mêmes</strong>. 
                Un endroit où l&apos;on peut récupérer en 20 minutes, pour moins de 15€, sans rendez-vous compliqué.
              </p>

              <div className="p-6 rounded-2xl bg-sage-50 border-l-4 border-sage-600">
                <p className="text-base italic text-gray-700 mb-2">
                  &quot;KAPSUL, c&apos;est la fusion de notre amour pour la tech et de notre besoin criant d&apos;humanité. 
                  Un Pod VR pour l&apos;esprit, des mains expertes pour le corps.&quot;
                </p>
                <p className="text-sm font-semibold text-sage-700">— Alexandre Martin, CEO</p>
              </div>
            </div>

            <div className="flex items-center gap-8 pt-6 border-t border-sage-200/50">
              <div className="text-center">
                <div className="font-serif text-4xl font-semibold text-charcoal mb-1">4</div>
                <div className="text-sm text-gray-600">Co-fondateurs</div>
              </div>
              <div className="w-px h-12 bg-sage-200/50" />
              <div className="text-center">
                <div className="font-serif text-4xl font-semibold text-sage-600 mb-1">18</div>
                <div className="text-sm text-gray-600">Mois de création</div>
              </div>
              <div className="w-px h-12 bg-sage-200/50" />
              <div className="text-center">
                <div className="font-serif text-4xl font-semibold text-charcoal mb-1">500+</div>
            ...
            {milestones.map((milestone, idx) => (
              ...
              >
                <div className="glass rounded-2xl p-6 border border-sage-100 h-full">
                  <div className="font-serif text-3xl font-semibold text-sage-600 mb-3">
                    {milestone.year}
                  </div>
                  <h3 className="font-semibold text-charcoal mb-2">{milestone.title}</h3>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-16 w-full">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Quatre profils complémentaires, une obsession commune : rendre le bien-être accessible à tous les urbains pressés
            </p>
          </motion.div>
                ...
                >
                  <div className="relative h-full p-8 rounded-3xl glass border border-sage-100 hover:border-sage-200 hover:shadow-xl transition-all duration-500 overflow-hidden">
                    ...
                    <div 
                      ...
                      style={{ background: `radial-gradient(circle at 50% 0%, ${member.color}15, transparent 70%)` }}
                    />
                    ...
                    <div className="relative z-10 space-y-6">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110 group-hover:rotate-6 duration-500"
                             style={{ backgroundColor: `${member.color}15` }}>
                          <Icon className="w-8 h-8" style={{ color: member.color }} strokeWidth={2} />
                        </div>
                      </div>
                      ...
                      {/* Quote */}
                      <div className="p-4 rounded-xl bg-sage-50/50 border-l-4" style={{ borderColor: member.color }}>
                        <p className="text-sm italic text-gray-700">&quot;{member.quote}&quot;</p>
                      </div>

                      {/* Infos */}
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center gap-2">
                          <Zap className="w-4 h-4 text-sage-600" strokeWidth={2} />
                          <span className="text-gray-600">
                            Super-pouvoir : <span className="text-charcoal font-semibold">{member.superpower}</span>
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          <Heart className="w-4 h-4 text-terra-500" strokeWidth={2} />
                          <span className="text-gray-600">
                            Service favori : <span className="text-charcoal font-semibold">{member.favoriteService}</span>
                          </span>
                        </div>
                      </div>
                        ...
                        {Object.entries(member.skills).map(([skill, value]) => (
                          <div key={skill}>
                            <div className="flex items-center justify-between mb-1.5">
                              ...
                              <span className="text-xs font-bold text-charcoal">{value}%</span>
                            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 w-full">
          ...
          >
            ...
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">
              Trois valeurs qui guident chaque décision, du choix des équipements à l&apos;accueil de nos clients
            </p>
          </motion.div>
              ...
              return (
                ...
                >
                  <div className="glass rounded-3xl p-8 border border-sage-100 hover:border-sage-200 hover:shadow-lg transition-all duration-500 h-full flex flex-col">
                    <div className="w-16 h-16 rounded-2xl mx-auto mb-6 flex items-center justify-center transition-transform group-hover:scale-110 group-hover:rotate-6 duration-500"
                         style={{ backgroundColor: `${value.color}15` }}>
                      <Icon className="w-8 h-8" style={{ color: value.color }} strokeWidth={2} />
                    </div>
                    ...
                    <div className="pt-4 border-t border-sage-200/50">
                      <div className="font-serif text-3xl font-semibold mb-1" style={{ color: value.color }}>
                        {value.metric}
                      </div>
                      <div className="text-xs text-gray-600">{value.metricLabel}</div>
                    </div>
                  </div>
                </motion.div>
              );
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-5xl">
          ...
          >
            ...
            <p className="text-lg text-gray-700">
              6 mois après l&apos;ouverture, les chiffres parlent d&apos;eux-mêmes
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-4xl text-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <Brain className="w-16 h-16 mx-auto text-sage-600" strokeWidth={1.5} />
            ...
            <p className="text-xl text-gray-700 max-w-2xl mx-auto">
              Venez vivre l&apos;expérience KAPSUL. Votre première session vous convaincra que <span className="text-sage-600 font-semibold">la récupération n&apos;est plus un luxe</span>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Link href="/reserver">
                <button className="group w-full sm:w-auto bg-sage-600 text-white hover:bg-sage-700 font-semibold py-4 px-8 rounded-full transition-all hover:shadow-lg hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-2">
                  ...
                  <Zap className="w-5 h-5 transition-transform group-hover:rotate-12" strokeWidth={2} />
                </button>
              </Link>
